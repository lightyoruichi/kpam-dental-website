  ...
  if (typeof value === "object" && value !== null) {
    ...
    if (is_array(value)) {
      ...
      for (var i = 0; i < value.length; i += 1) {
        var element = value[i];
        if (i in value) {
          copy[i] = clone(element, cloned, false_default ? `${path}[${i}]` : path, paths);
        }
      }
      return copy;
    }
    if (get_prototype_of(value) === object_prototype) {
      ...
      for (var key in value) {
        copy[key] = clone(value[key], cloned, false_default ? `${path}.${key}` : path, paths);
      }
      return copy;
    }
...
function unset_context() {
  ...
  if (false_default) set_from_async_derived(null);
}
...
function internal_set(source2, value) {
  if (!source2.equals(value)) {
    ...
    if (false_default && inspect_effects.size > 0 && !inspect_effects_deferred) {
...
function proxy(value) {
  ...
  var version = state(0);
  var stack2 = false_default && tracing_mode_flag ? get_stack("CreatedAt") : null;
...
//# sourceMappingURL=chunk-QGHSSR5A.js.map
