/* empty css                                 */
import { e as createAstro, f as createComponent, m as maybeRenderHead, k as renderScript, h as addAttribute, r as renderTemplate, l as renderComponent, n as renderSlot, o as renderHead } from '../chunks/astro/server_DLNKQoXW.mjs';
import 'kleur/colors';
import 'clsx';
export { renderers } from '../renderers.mjs';

const $$Astro$5 = createAstro("https://yourrestaurant.com");
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  const navigation = [
    ...
    { name: "Specialized Care", href: "/#specialized-services" },
    { name: "Location", href: "/#locations" },
    { name: "About", href: "/#about" },
    { name: "Contact", href: "/#contact" }
  ];
  return renderTemplate`${maybeRenderHead()}<header class="bg-base-100/95 backdrop-blur-md shadow-lg sticky top-0 z-50 transition-all duration-300" id="header"> <nav class="container-custom"> <div class="flex items-center justify-between h-20"> <!-- Logo --> <div class="flex items-center"> <a href="/" class="flex items-center space-x-3"> <div class="w-12 h-12 bg-primary rounded-full flex items-center justify-center"> <span class="text-primary-content font-bold text-xl">K</span> </div> <div> <h1 class="text-2xl font-bold text-base-content">KPAM</h1> <p class="text-sm text-base-content/70">Klinik Pergigian Alam Megah</p> </div> </a> </div> <!-- Desktop Navigation --> <div class="hidden md:flex items-center space-x-8"> ${navigation.map((item) => renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(`font-medium transition-colors duration-200 ${currentPage === item.name.toLowerCase() || currentPage === "home" && item.name === "Home" ? "text-primary border-b-2 border-primary" : "text-base-content hover:text-primary"}`, "class")}> ${item.name} </a>`)} <a href="https://wa.me/601137118155" class="btn-primary hidden sm:inline-flex" target="_blank">
Book Appointment
</a> </div> <!-- Mobile menu button --> <div class="md:hidden"> <button id="mobile-menu-button" class="text-base-content hover:text-primary transition-colors duration-200" aria-label="Toggle mobile menu"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path> </svg> </button> </div> </div> <!-- Mobile Navigation --> <div id="mobile-menu" class="md:hidden hidden border-t border-base-300"> <div class="px-2 pt-2 pb-3 space-y-1"> ${navigation.map((item) => renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(`block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 ${currentPage === item.name.toLowerCase() || currentPage === "home" && item.name === "Home" ? "text-primary bg-primary/10" : "text-base-content hover:text-primary hover:bg-primary/5"}`, "class")}> ${item.name} </a>`)} <a href="https://wa.me/601137118155" class="block w-full text-center btn-primary mt-4" target="_blank">
Book Appointment
</a> </div> </div> </nav> </header> ${renderScript($$result, "/Users/lightyoruichi/Dev/resto/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/lightyoruichi/Dev/resto/src/components/Header.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer class="bg-neutral text-neutral-content"> <div class="container-custom section-padding"> <div class="grid grid-cols-1 md:grid-cols-4 gap-8"> <!-- Clinic Info --> <div class="md:col-span-2"> <div class="flex items-center space-x-3 mb-4"> <div class="w-12 h-12 bg-primary rounded-full flex items-center justify-center"> <span class="text-primary-content font-bold text-xl">K</span> </div> <div> <h3 class="text-2xl font-bold">Klinik Pergigian Alam Megah</h3> <p class="text-neutral-content/70">Professional Dental Care</p> </div> </div> <p class="text-neutral-content/80 mb-4 max-w-md">
Providing comprehensive dental care in Shah Alam with modern technology and compassionate service. 
          We're committed to maintaining your oral health and enhancing your smile with professional dental treatments.
</p> <div class="flex space-x-4"> <a href="https://instagram.com/klinikpergigian_alammegah" class="text-neutral-content/70 hover:text-primary transition-colors duration-200" target="_blank"> <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"> <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"></path> </svg> </a> <a href="https://tiktok.com/@kpam06" class="text-neutral-content/70 hover:text-primary transition-colors duration-200" target="_blank"> <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"> <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"></path> </svg> </a> <a href="https://wa.me/601137118155" class="text-neutral-content/70 hover:text-primary transition-colors duration-200" target="_blank"> <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"> <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488"></path> </svg> </a> </div> </div> <!-- Quick Links --> <div> <h4 class="text-lg font-semibold mb-4">Quick Links</h4> <ul class="space-y-2"> <li><a href="/" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">Home</a></li> <li><a href="/#services" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">Services</a></li> <li><a href="/#specialized-services" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">Specialized Care</a></li> <li><a href="/#locations" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">Location</a></li> <li><a href="/#about" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">About</a></li> <li><a href="/#contact" class="text-neutral-content/70 hover:text-primary transition-colors duration-200">Contact</a></li> </ul> </div> <!-- Contact Info --> <div> <h4 class="text-lg font-semibold mb-4">Contact Info</h4> <div class="space-y-3"> <div class="flex items-start space-x-3"> <svg class="w-5 h-5 text-primary mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path> </svg> <div> <p class="text-neutral-content/70">No. 123, Jalan Alam Megah 2</p> <p class="text-neutral-content/70">Taman Alam Megah, 40470 Shah Alam, Selangor</p> </div> </div> <div class="flex items-center space-x-3"> <svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path> </svg> <p class="text-neutral-content/70">+6 011-3711 8155</p> </div> <div class="flex items-center space-x-3"> <svg class="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24"> <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488"></path> </svg> <p class="text-neutral-content/70">wa.me/601137118155</p> </div> </div> </div> </div> <!-- Bottom Bar --> <div class="border-t border-neutral-content/20 mt-8 pt-8"> <div class="flex flex-col md:flex-row justify-between items-center"> <p class="text-neutral-content/70 text-sm">
© ${currentYear} Klinik Pergigian Alam Megah. All rights reserved.
</p> <div class="flex space-x-6 mt-4 md:mt-0"> <a href="/privacy" class="text-neutral-content/70 hover:text-primary transition-colors duration-200 text-sm">Privacy Policy</a> <a href="/terms" class="text-neutral-content/70 hover:text-primary transition-colors duration-200 text-sm">Terms of Service</a> </div> </div> </div> </div> </footer>`;
}, "/Users/lightyoruichi/Dev/resto/src/components/Footer.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title,
    description,
    image = "https://images.pexels.com/photos/4173251/pexels-photo-4173251.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop",
    currentPage,
    showTally = false
  } = Astro2.props;
  const canonicalURL = new URL(Astro2.url.pathname, Astro2.site);
  return renderTemplate(_a || (_a = __template(['<html lang="en" data-theme="dental" data-astro-cid-losip7nv> <head><meta charset="UTF-8"><meta name="description"', '><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="canonical"', "><!-- Primary Meta Tags --><title>", '</title><meta name="title"', '><meta name="description"', '><meta name="keywords" content="dental clinic, dentist, dental care, teeth cleaning, dental treatment, Shah Alam, Selangor, Malaysia, dental services, oral health, dental checkup, teeth whitening, dental implants, root canal"><meta name="author" content="Klinik Pergigian Alam Megah"><meta name="robots" content="index, follow"><meta name="language" content="en-US"><meta name="revisit-after" content="7 days"><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:site_name" content="Klinik Pergigian Alam Megah"><meta property="og:locale" content="en_US"><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"', '><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image"', '><meta property="twitter:site" content="@klinikpergigian_alammegah"><meta property="twitter:creator" content="@klinikpergigian_alammegah"><!-- Google Fonts --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><!-- Enhanced Structured Data for SEO --><script type="application/ld+json">\n      {\n        "@context": "https://schema.org",\n        "@type": "Restaurant",\n        "name": "Restaurant Name",\n        "alternateName": "Fine Dining Restaurant",\n        "description": "Experience exceptional cuisine in an elegant atmosphere. Fine dining restaurant offering fresh, locally-sourced ingredients and impeccable service with multiple locations.",\n        "url": "https://yourrestaurant.com",\n        "logo": "https://yourrestaurant.com/logo.png",\n        "image": "https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&cs=tinysrgb&w=1200&h=630&fit=crop",\n        "telephone": "+1-555-123-4567",\n        "email": "info@yourrestaurant.com",\n        "address": [\n          {\n            "@type": "PostalAddress",\n            "streetAddress": "123 Main Street",\n            "addressLocality": "Your City",\n            "addressRegion": "Your State",\n            "postalCode": "12345",\n            "addressCountry": "US"\n          },\n          {\n            "@type": "PostalAddress",\n            "streetAddress": "456 Oak Avenue",\n            "addressLocality": "Your City",\n            "addressRegion": "Your State",\n            "postalCode": "12345",\n            "addressCountry": "US"\n          },\n          {\n            "@type": "PostalAddress",\n            "streetAddress": "789 Harbor View",\n            "addressLocality": "Your City",\n            "addressRegion": "Your State",\n            "postalCode": "12345",\n            "addressCountry": "US"\n          }\n        ],\n        "geo": {\n          "@type": "GeoCoordinates",\n          "latitude": "40.7128",\n          "longitude": "-74.0060"\n        },\n        "medicalSpecialty": "Dentistry",\n        "priceRange": "$$",\n        "openingHours": "Mo-Su 17:00-22:00",\n        "paymentAccepted": ["Cash", "Credit Card", "Debit Card"],\n        "currenciesAccepted": "USD",\n        "hasMenu": "https://yourrestaurant.com/menu",\n        "acceptsReservations": true,\n        "smokingAllowed": false,\n        "wheelchairAccessible": true,\n        "aggregateRating": {\n          "@type": "AggregateRating",\n          "ratingValue": "4.9",\n          "reviewCount": "500",\n          "bestRating": "5",\n          "worstRating": "1"\n        },\n        "review": [\n          {\n            "@type": "Review",\n            "author": {\n              "@type": "Person",\n              "name": "Sarah Johnson"\n            },\n            "reviewRating": {\n              "@type": "Rating",\n              "ratingValue": "5",\n              "bestRating": "5"\n            },\n            "reviewBody": "Exceptional dining experience with innovative cuisine and impeccable service. The wagyu tenderloin was absolutely divine."\n          }\n        ],\n        "sameAs": [\n          "https://www.facebook.com/yourrestaurant",\n          "https://www.instagram.com/yourrestaurant",\n          "https://www.twitter.com/yourrestaurant"\n        ],\n        "foundingDate": "2010",\n        "founder": {\n          "@type": "Person",\n          "name": "Chef Name"\n        }\n      }\n    <\/script><!-- Additional Schema for Local Business --><script type="application/ld+json">\n      {\n        "@context": "https://schema.org",\n        "@type": "MedicalBusiness",\n        "name": "Klinik Pergigian Alam Megah",\n        "description": "Professional dental clinic providing comprehensive dental care services in Shah Alam",\n        "url": "https://kpam.my",\n        "telephone": "+6-011-3711-8155",\n        "address": {\n          "@type": "PostalAddress",\n          "streetAddress": "123, Jalan Alam Megah 1/1, Taman Alam Megah",\n          "addressLocality": "Shah Alam",\n          "addressRegion": "Selangor",\n          "postalCode": "40000",\n          "addressCountry": "MY"\n        },\n        "openingHours": "Mo-Fr 09:00-18:00, Sa 09:00-16:00",\n        "priceRange": "$$"\n      }\n    <\/script>', '</head> <body class="bg-base-100 text-base-content" data-astro-cid-losip7nv> ', " <main data-astro-cid-losip7nv> ", " </main> ", " <!-- Tally.so Script --> ", " </body> </html> "])), addAttribute(description, "content"), addAttribute(canonicalURL, "href"), title, addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(image, "content"), addAttribute(Astro2.url, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(image, "content"), renderHead(), renderComponent($$result, "Header", $$Header, { "currentPage": currentPage, "data-astro-cid-losip7nv": true }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-losip7nv": true }), showTally && renderTemplate`${renderScript($$result, "/Users/lightyoruichi/Dev/resto/src/components/BaseLayout.astro?astro&type=script&index=0&lang.ts")}`);
